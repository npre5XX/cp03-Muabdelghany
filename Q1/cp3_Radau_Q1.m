...
xlabel('x [Cm]')
ylabel('\psi(x,\mu_n)')
title('Partial Flux Distribution Using Radau Quadrature for the First 4 Quadratures')
...
xlabel('x [Cm]')
ylabel('\psi_+(x)')
title('Rightward Angular Flux Distribution \psi_R(x) Using Radau Quadrature for 120 Space Mesh')
...
xlabel('x [Cm]')
ylabel('\psi_L(x)')
title('Leftward Angular Flux Distribution \psi_-(x) Using Radau Quadrature for 120 Space Mesh')
...
xlabel('x [Cm]')
ylabel('\phi(x)')
title('Scalar Flux Distribution \phi(x) Using Radau Quadrature for 120 Space Mesh')
